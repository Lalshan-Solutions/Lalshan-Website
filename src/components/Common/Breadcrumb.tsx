          ...
          <div className="-mx-4 flex flex-wrap items-center justify-center">
            <div className="w-full px-4 md:w-10/12 lg:w-8/12">
              <div className="mx-auto mb-10 max-w-[800px] text-center">
                {/* Badge if provided - centered above links */}
                {badge && (
                ...
                <ul className="mb-6 flex items-center justify-center space-x-2">
                  <li className="flex items-center">
                    <Link
                      href="/"
                      className="text-base font-medium text-body-color hover:text-primary transition-colors duration-300"
                    >
                      Home
                    </Link>
                ...
                <h1 className="mb-5 text-3xl font-bold text-black dark:text-white sm:text-4xl md:text-[45px]">
